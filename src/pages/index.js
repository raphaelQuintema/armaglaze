  ...
  <Layout bg="container bg-yellow">
    ...
    <div className="row">
      <div className="col-lg-6 col-md-12 col-sm-12 bg-black abs-box text-white box-mr-1">
        ...
        <p>
          Cylinder with internal thumbturn, 3 keys & card Supplied & Fitted for
          Just £88.00+ Vat
        </p>
      ...
      <div className="col-lg-6 col-md-12 col-sm-12 bg-black abs-box text-white box-ml-1">
        ...
        <p>
          Half Cylinder (no external access) Supplied & Fitted For Just £81.00+
          Vat
        </p>
    ...
    <div className="row py-4">
      ...
      <div className="col-lg-6 col-md-12 col-sm-12">
        <ul>
          ...
          <li>Secured by Design Accredited (Police preferred specification)</li>
