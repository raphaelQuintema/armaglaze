  ...
  <Layout bg="container bg-black">
    ...
    <div className="row py-4">
      ...
      <div className="col-lg-6 col-md-12 col-sm-12">
        ...
        <br />
        <p>
          Abs Quantum Thumturn locks allow easy exit in case of an emergency and
          its easy internal locking and unlocking function means you only need
          to use the key when leaving and entering your house. Recommended by
          emergency services
        </p>
        <br />
        <button type="button" className="btn btn-dark">
    ...
    <div className="d-flex flex-column text-white pt-5 mb-3 border-bottom">
      <ul className="d-flex flex-row no-list-type pl-5">
        <li className="mr-5">
          <Link className="text-yellow-link">FEATURES</Link>
        </li>
        <li className="mr-5">
          <Link className="text-yellow-link">SPECIFICATIONS</Link>
        </li>
        <li>
          <Link className="text-yellow-link">GUIDES & DOWNLOADS</Link>
        </li>
      </ul>
    </div>
    <div className="row d-flex justify-content-center mt-4">
      ...
      <div>
        <ul>
          ...
          <li>
            Unique patented Snap Secure Technology - The Active Cam system locks
            the cylinder after a snap attack to keep intruders out
          </li>
